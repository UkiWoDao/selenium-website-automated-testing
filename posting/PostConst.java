...
//	private static String IMGUPLOAD = "image"; // element id
	...
	private static String POSTEDITSUBMIT = "/html/body/div[1]/div[6]/form/input[4]";
	private static String POSTSBYCLASS = "*[@class=\"posts\"]";
	
	public static String getPOSTSBYCLASS() {
		return POSTSBYCLASS;
	}
	...
	public static String getPOSTEDITSUBMIT() {
		return POSTEDITSUBMIT;
	}
}
